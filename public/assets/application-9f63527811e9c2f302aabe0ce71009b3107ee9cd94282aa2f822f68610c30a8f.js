  ...
  (function($, window) {
    ...
    InfinitePages = (function() {
      ...
      InfinitePages.prototype.init = function() {
        var debounce, scrollHandler, scrollTimeout;
        scrollTimeout = null;
        ...
        return this.$context.on('scroll.infinitePages', function() {
      ...
      InfinitePages.prototype.next = function() {
        if (this.options.state.done) {
          ...
          this._loading();
          return this.jqXHR = $.getScript(this.$container.find(this.options.navSelector).attr('href')).done((function(_this) {
            return function() {
      ...
      InfinitePages.prototype.stop = function() {
        this.$context.off('scroll.infinitePages');
        return this._log("Scroll checks stopped");
      };

      InfinitePages.prototype.abort = function() {
        if (this.jqXHR) {
          this.jqXHR.abort();
          this.jqXHR = null;
...
(function() {
  $(function() {
    return $('.pagination').infinitePages({
      debug: true,
      loading: function() {
